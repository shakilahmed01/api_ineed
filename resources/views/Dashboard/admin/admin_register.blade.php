...
<body>
    ...
    <div class="container">
        <img src="{{asset('Dashboard/public/assets/images/admin_logo.png')}}" alt="" width="150">
        <!-- toggle form html -->
        <div class="row ">
            <div class="col-lg-7 col-sm-12">
                ...
                <!-- Customer Form -->
                <form class="row g-3" method="POST" action="{{ route('newregister') }}" enctype="multipart/form-data" class="customer_form" id="customer_form">
                  @csrf
                    <div class=" ">
                        <h2>Customer Form</h2>
                    </div>
                ...
                <!-- Admin Form -->
                <form class="row g-3" method="POST" action="{{ route('newregister') }}" enctype="multipart/form-data" class="customer_form" id="admin_form">
                  @csrf
                    <div class=" ">
                        <h2>Admin Form</h2>
                    </div>
                ...
                <form class="row g-3" method="POST" action="{{ route('newregister') }}" enctype="multipart/form-data" class="customer_form" id="partner_merchant_form">
                  @csrf
                    <div class=" ">
                ...
                <form class="row g-3" method="POST" action="{{ route('newregister') }}" enctype="multipart/form-data" class="customer_form" id="grocery_merchant_form">
                  @csrf
                    <div class=" ">
